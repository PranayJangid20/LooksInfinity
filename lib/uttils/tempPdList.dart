...
import '../featues/account/presentation/my_wishlist_screen.dart';


FirebaseFirestore firestore = FirebaseFirestore.instance;
class LProd extends StatefulWidget {
  String qur;
  LProd({Key ? key, required this.qur}) : super(key: key);
  @override
  _LProdState createState() => _LProdState();
}

class _LProdState extends State<LProd> {
          ...
          children: [
            ...
            Expanded(
              child: Padding(
                ...
                child: StreamBuilder(
                    stream:
                    firestore.collection("Store").doc("ITEM").collection("itms").where("pCatg",isEqualTo: "MEN").snapshots(),
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return GestureDetector(onTap: () {
                            Navigator.of(context).push(
                                MaterialPageRoute(
                                    builder: (context) => ProductDetailScreen(prod: snapshot.data.docs[index]["pId"],)));
                          },
                              child: Window(
                                id: snapshot.data.docs[index].data(),));
                        },
                      ):Text("data Not Found"):Center(child: CircularProgressIndicator());
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      }, child: Window(id: product_list[index],));
                    },
                  );*/
                    }
                ),
